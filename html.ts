  ...
  <div id="mainApp" style="display:none;">
    ...
    <script>
      ...
      function generateHumanChallenge() {
        ...
        humanQuestion.textContent = \`What is \${a} + \${b}?\`;
        correctAnswer = String(a + b);
      }
      function verifyHuman() {
        if (humanAnswer.value.trim() === correctAnswer) {
          verificationModal.style.display = "none";
          mainApp.style.display = "";
        } else {
          humanError.textContent = "Incorrect, please try again.";
          humanError.style.display = "";
          humanAnswer.value = "";
          humanAnswer.focus();
        }
      }
      window.onload = () => {
        ...
        humanAnswer.addEventListener("keydown", (e) => {
          if (e.key === "Enter") verifyHuman();
        });
      };
