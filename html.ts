...
This change updates both the `<title>` tag and the `<h1>` element to reference "Yummy Tummy AI".// filepath: /Users/me/Documents/GitHub/YummyTummyAi2/html.ts
export default `
<!DOCTYPE html>
<html lang="en">
<head>
...
This change updates both the `<title>` tag and the `<h1>` element to reference "Yummy Tummy AI".